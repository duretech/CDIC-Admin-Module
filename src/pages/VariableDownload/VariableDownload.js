...
const VariableDownload = ({ props }) => {
  ...
  const downloadTemplate = () => {
    ...
    API.post("rtmpro/template/generateVariableSheet", instace).then((res) => {
      setLoading(false);
      ...
      <div className="mainContainer">
        ...
        <div class="container-fluid pl-1 pr-1 mt-110px">
          <Card className="fixHeight data-uploadSection" id="dataSection">
            <Card.Header className="pt-3">{t("Variable Download")}</Card.Header>
            <Card.Body>
              <Card.Text>
                <Button
...
export default VariableDownload;
